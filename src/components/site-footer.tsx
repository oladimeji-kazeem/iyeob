    ...
    <footer className="border-t border-border bg-foreground text-primary-foreground">
      <div className="mx-auto grid max-w-7xl gap-12 px-5 py-16 sm:grid-cols-2 lg:grid-cols-5 lg:px-8">
        <div className="sm:col-span-2">
          <Link to="/" className="flex items-center gap-2.5"><img src={logo} alt="IYEOB logo" className="size-10 object-contain" /><span className="font-display text-xl font-extrabold">IYEOB</span></Link>
